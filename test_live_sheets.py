...
def test_sales_order_data_sheet_layout():
    ...
    # its COMPONENT row (price/type tails stripped), then its ATTRIBUTE row, banded
    ...
    assert sh.grid[2][tkey + 3].value == "ATTRIBUTE" and sh.grid[2][tkey].fill is None
