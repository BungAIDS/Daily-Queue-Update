...
def shortcut_vbs_text(html_name: str = HTML_NAME, ico_name: str = ICON_ICO_NAME) -> str:
    ...
    fallback; the shortcut is for users who want a real custom icon."""
    lines = [
        ...
        "Option Explicit",
        "Dim fso, shell, here, page, iconPath, edge, chrome, target, args, desktop, lnk",
        "Set fso = CreateObject(\"Scripting.FileSystemObject\")",
        "Set shell = CreateObject(\"WScript.Shell\")",
        "here = fso.GetParentFolderName(WScript.ScriptFullName)",
        "page = fso.BuildPath(here, \"" + html_name + "\")",
        ...
        "  target = \"msedge\"",
        "End If",
        "args = \"--start-maximized --window-position=0,0 --window-size=3840,2160 --app=\"\"file:///\" & Replace(page, \"\\\", \"/\") & \"\"\"",
